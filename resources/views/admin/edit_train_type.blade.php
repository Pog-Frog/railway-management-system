...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div
        ...
        <h1 class="h4">Edit Train type</h1>
    </div>
    <div
        class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <form method="POST" action="{{route('edit_train_type', ['train_type_id'=>($train_type->id)])}}">
            @csrf
            ...
            <div class="row g-3">
                <div class="col-lg-9">
                    <label for="name" class="form-label">Train name<span
                ...
                <div class="col-sm-9">
                    <button class="w-50 btn btn-outline-primary btn-md" type="submit">Submit</button>
                </div>
        </form>
        <form method="POST" action="{{route('delete_train_type', ['train_type_id'=>($train_type->id)])}}">
            @csrf
            <div class="col w-auto">
                <button class="w-25 btn btn-primary btn-danger btn-sm" type="submit">Delete Train type</button>
            </div>
        </form>
    </div>
</main>
